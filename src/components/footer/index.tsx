...
export default function Footer() {
    ...
    return (
        <FooterSection>
            ...
            <LeftColumn>
                <LogoCircle onClick={scrollToTop}>
                    <img src={logo} alt="Logo" />
                </LogoCircle>
                <CrestLink 
                    href="https://www.pm.pi.gov.br/hpm.php" 
                    target="_blank" 
                    rel="noopener noreferrer"
                >
                    <CrestImage src={crest} alt="Brasão do Piauí" />
                </CrestLink>
                <Copyright>© 2026 Sorriso Especial</Copyright>
            </LeftColumn>
            ...
            <RightColumn>
                ...
                <InstagramIcon 
                    href="https://www.instagram.com/sorrisoespecial_hpm/" 
                    target="_blank" 
